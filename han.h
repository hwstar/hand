...
#define HAN_CMD_RLYN_SRLY	0x10	// Set or reset a relay, 2 parms reqd.
#define HAN_CMD_RLYN_GSLS	0x11	// Return sense line status, 3 parms reqd.
#define HAN_CMD_RLYN_GTMP	0x12	// Return temperature, 3 parms reqd.
#define HAN_CMD_RLYN_GPCY 0x1F  // Return whether a power cycle has occurred.

/* Broadcast packet commands */
