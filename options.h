...
#define DEBUGLVL 0                        // Debugging level (0 = none)
...
#define IRR_CONF_FILE_PATH "/etc/irr.conf"// Path to irr.conf file
#define IRR_STATE_FILE_PATH "/var/run/irr.state"  // Path to irr.state file

// hand configs

#define CONF_LOG_PATH "/var/log/hand.log" // Path to log file
#define CONF_TTY "/dev/ttyS0"
#define DAEMON_SOCKET_FILE "hand.socket"// Unix domain socket name
#define MAX_NODE_ADDR 0x1F		// Default maxmum node address
